...
apt-get -y install --no-install-recommends xubuntu-desktop \
	...
	indicator-application indicator-messages indicator-sound laptop-detect libcurl3 \
	libnotify-bin light-locker lightdm-gtk-greeter-settings menulibre mousepad pavucontrol \
	ristretto ttf-ubuntu-font-family update-notifier xfce4-indicator-plugin xfce4-power-manager \
